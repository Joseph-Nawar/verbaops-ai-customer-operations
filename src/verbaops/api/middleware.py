...
from verbaops.api.errors import internal_error_response
from verbaops.observability.context import bind_request_context, clear_request_context
...
class RequestContextMiddleware:
    ...
    def __init__(self, app: ASGIApp) -> None:
        self.app = app
        self.logger = logging.getLogger("verbaops.http")
